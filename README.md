...
```bash
aws-cloud-resume$ pip install pytest pytest-mock --user
aws-cloud-resume$ python -m pytest tests/ -v
```
...
```bash
aws cloudformation delete-stack --stack-name aws-cloud-resume
```
